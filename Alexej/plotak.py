...
def dummy(dataframe):
    ...
    fig.update_layout({
        'plot_bgcolor': 'rgba(255,100,20,0.1)',
        'paper_bgcolor': 'rgba(255,100,20,0.1)'
    })
    ...
    fig.add_vline(x=1982, line_width=3, line_dash="dash", line_color="green"annotation_text="test", annotation_text="ThisIsAtestText")
