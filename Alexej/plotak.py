...
def dummy(dataframe):
    ...
    fig.add_vline(x=1949, line_width=3, line_dash="dash", line_color="red", annotation_text="the Soviet Union secretly conducted its first successful weapon test (First Lightning, based on the American 'Fat Man' design) at the Semipalatinsk-21 in Kazakhstan. => ending the United States' monopoly on nuclear weapons.")
